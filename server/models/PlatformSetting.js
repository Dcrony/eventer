...
const platformSettingSchema = new mongoose.Schema(
  {
    ...
    payouts: {
      ...
      holdingPeriodHours: { type: Number, default: 48, min: 1 },
      earlyPayoutPercentVerified: { type: Number, default: 50, min: 0, max: 100 },
      earlyPayoutPercentTrusted: { type: Number, default: 80, min: 0, max: 100 },
