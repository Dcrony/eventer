          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] min-h-[600px] ">
            ...
            <div className="md:block hidden relative bg-gradient-to-br from-white via-pink-50/50 to-gray-50 p-8 lg:p-10 overflow-hidden border-r border-gray-100">
              ...
              <div className="relative z-10 max-w-md">
                ...
                <div className="mt-5 space-y-2">
                  ...
                  <p className="inline-flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <CheckCircle2 size={14} className="text-pink-500" /> QR check-in and attendee control
                  </p>
                  <p className="inline-flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <CheckCircle2 size={14} className="text-pink-500" /> Stream, message, and analytics in one workflow
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 lg:p-10 bg-white/95">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500">Sign in to manage events, tickets, and attendees.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-right mt-1">
                    <Link to="/forgot-password" className="text-xs font-semibold text-pink-500 hover:text-pink-600 transition-colors">
                      Forgot password?
                    </Link>
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-2.5 rounded-xl bg-pink-500 text-white text-sm font-bold transition-all duration-200 hover:bg-pink-600 hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 shadow-lg shadow-pink-500/25 flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-[0.65rem] text-gray-400 mt-3">
                  ...
                  <Link to="/privacy" className="hover:text-pink-500 transition-colors">Privacy</Link> policy.
                </p>
              </div>
            </div>
          </div>
