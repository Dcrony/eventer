...
import { Code2, Package, Webhook, ArrowRight, Shield, Zap, Server } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 font-geist">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-pink-500 text-white font-semibold hover:bg-pink-600 transition-all duration-200"
              >
                View Documentation
                <ArrowRight size={18} />
              </a>
              <Link
                to="/register"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 text-white font-semibold hover:bg-white/20 transition-all duration-200"
              >
                Get API Keys
              </Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* REST API Card */}
          <div className="bg-white rounded-2xl border border-gray-200 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-pink-400">Quick Start</span>
              </div>
              <h3 className="text-xl font-extrabold mb-2">Get started in minutes</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-pink-500 text-white font-semibold hover:bg-pink-600 transition-all duration-200 whitespace-nowrap"
            >
              Quick Start Guide
              <ArrowRight size={16} />
            </a>
