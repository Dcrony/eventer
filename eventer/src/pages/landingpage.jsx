  ...
  const heroSlides = [
    {
      ...
      subtitle: "From intimate gatherings to large-scale productions, bring your vision to life",
    ...
    },
    {
      ...
      subtitle: "Connect with your audience globally through integrated live streaming",
      image: "https://cdn.pixabay.com/photo/2016/11/23/15/48/audience-1853662_1280.jpg"
    },
    {
      title: "Secure Ticketing & QR Codes",
      subtitle: "Streamlined ticket sales with instant QR code generation and secure payments",
    ...
    <div className="landing-page">
      ...
      <section className="features">
        <div className="container">
          ...
          <p className="section-subtitle">Everything you need to create, manage, and monetize your events</p>
